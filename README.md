...
* **Основная (для портфолио и клиентов):**  
  ...
  - https://cc50985-wordpress-mpooh.tw1.ru/danila/

* **Для админства:**
- https://cc50985-wordpress-mpooh.tw1.ru/danila/wp-admin
...
8. **ACF использовался для картинки hero** — поле `hero_image` выводится через `<img>` с классом `.hero__image-ACF`. Для остальных блоков контент статичный.
...
🔥 Где взять пароль от phpMyAdmin(Базы данных -> phpMyAdmin):
1. Открой файловый менеджер Timeweb.

2. Зайди в папку danila.

3. Открой файл wp-config.php.

4. Найди там строчки:
```php
/** Имя базы данных для WordPress */
define( 'DB_NAME', 'cc50985_mpooh' );

/** Имя пользователя базы данных */
define( 'DB_USER', 'cc50985_mpooh' );
